...
class Html{
    ...
    public static function addLink(array $param){ self::$link[] = '<link ' . self::__convertParam($param) . '>'; }

    public static function addMeta(array $param){ self::$meta[] = '<meta ' . self::__convertParam($param) . '>'; }
    ...
    public static function setHeader(string $view){ self::$header = $view; }
